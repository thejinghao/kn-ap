...
export const AP_HOSTED_STEPS: StepTemplate[] = [
  ...
  { id: 'aph-6', from: 'ap-frontend', to: 'klarna-api', label: 'Authorize payment (mTLS)', sublabel: 'POST /payment/authorize', type: 'call' },
  ...
  { id: 'aph-11', from: 'ap-frontend', to: 'klarna-api', label: 'Final authorize (mTLS)', sublabel: '+ Klarna-Network-Session-Token', type: 'call' },
...
export const SERVER_SIDE_STEPS: StepTemplate[] = [
  ...
  { id: 'ss-6', from: 'sub-partner', to: 'klarna-api', label: 'Authorize payment (via AP, mTLS)', sublabel: 'POST /payment/authorize', type: 'call' },
  ...
  { id: 'ss-12', from: 'ap-backend', to: 'klarna-api', label: 'Final authorize (mTLS)', sublabel: '+ Klarna-Network-Session-Token', type: 'call' },
