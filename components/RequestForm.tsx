      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 flex-shrink-0">
            <span className="text-lg font-semibold text-gray-900">New Request</span>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
            <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
              ...
              {/* Path Parameters - auto-expand in full-page */}
              {pathParams.length > 0 && (
                <div className="border border-gray-300 rounded">
                  <div className="w-full flex items-center justify-between px-3 py-1.5 bg-gray-50">
                    <span className="flex items-center gap-1">
                      <ChevronDownIcon className="w-3.5 h-3.5 text-gray-600" />
                      <span className="text-xs font-medium text-gray-700">
                        Parameters ({pathParams.length})
                        {hasRequiredMissingParams && <span className="ml-1 text-red-500">*</span>}
                      </span>
                    </span>
                  </div>
              ...
              {/* Headers - auto-expand in full-page */}
              <div className="border border-gray-300 rounded">
                <div className="w-full flex items-center justify-between px-3 py-1.5 bg-gray-50">
                  <span className="flex items-center gap-1">
                    <ChevronDownIcon className="w-3.5 h-3.5 text-gray-600" />
              ...
              {/* Request Body - MORE ROWS in full-page */}
              {showBodyEditor && (
